...
/* Includes ------------------------------------------------------------------*/
#if defined(__has_include) && __has_include("stm32f1xx_hal_conf.h")
  #include "stm32f1xx_hal_conf.h"
#else
  /* Fallback to a minimal inline default config if the real config header
     stm32f1xx_hal_conf.h is not present. Replace or provide a project-specific
     stm32f1xx_hal_conf.h for full functionality. */
  #ifndef STM32F1XX_HAL_CONF_DEFAULT_H
  #define STM32F1XX_HAL_CONF_DEFAULT_H

  #include <stdint.h>
  #include <stddef.h>

  /* Basic default definitions (adjust as necessary) */
  #define HAL_MODULE_ENABLED

  /* Default clock values (common defaults; override in your config file) */
  #ifndef HSE_VALUE
  #define HSE_VALUE    ((uint32_t)8000000U) /* 8 MHz */
  #endif

  #ifndef HSI_VALUE
  #define HSI_VALUE    ((uint32_t)8000000U) /* 8 MHz */
  #endif

  #endif /* STM32F1XX_HAL_CONF_DEFAULT_H */
#endif
